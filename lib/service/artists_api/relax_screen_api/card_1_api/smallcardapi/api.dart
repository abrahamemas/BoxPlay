...
final artistsTitle4 = Provider<Api>((ref) => Api());

final artistsTitledataprovider4 = FutureProvider<List<ModelTitle>>((ref) async {
  final apiservices2 = ref.read(artistsTitle4);
