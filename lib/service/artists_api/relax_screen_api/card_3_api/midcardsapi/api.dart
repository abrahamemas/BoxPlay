...
class ApiService {
  ...
  Future<List<ArtistsModel>> getArtists() async {
    try {
      Response response = await _dio.get('$endpoint/search?q=post malone');
...
final artistsDataProvider10 = FutureProvider<List<ArtistsModel>>((ref) async {
...
final artistsTitleDataProvider11 =
