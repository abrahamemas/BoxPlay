...
class GridCard3 extends ConsumerWidget {
  const GridCard3({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, ref) {
    final data = ref.watch(artistsBottomDataProvider3);
    final data2 = ref.watch(artistsBottomTitleDataProvider3);
