...
class EnergizeSmallCard extends ConsumerWidget {
  ...
  const EnergizeSmallCard({Key? key, required this.startIndex}) : super(key: key);

  @override
  Widget build(BuildContext context, ref) {
    final data = ref.watch(artistsDataProvider7);
    final data2 = ref.watch(artistsTitleDataProvider10);
