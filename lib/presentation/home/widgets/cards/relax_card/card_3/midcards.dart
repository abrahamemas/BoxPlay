...
import 'package:music_app/service/artists_api/relax_screen_api/card_3_api/midcardsapi/api.dart';

class RelaxMidCard3 extends ConsumerWidget {
  const RelaxMidCard3({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, ref) {
    final data = ref.watch(artistsDataProvider10);
    final data2 = ref.watch(artistsTitleDataProvider11);
